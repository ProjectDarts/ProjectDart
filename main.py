...
class MainManager:
    ...
    def refresh_name_suggestions(self):
        """Aktualisiert die Top-3-Vorschläge für das aktive Eingabefeld."""
    ...
    def finalize_selected_players(self):
        """
        Verwendet bestehende Spielernamen oder legt neue automatisch an.
        Aktualisiert außerdem when_last_played.
        Rückgabe: finale Liste der Spielernamen in der Reihenfolge der Eingabe.
        """
        final_names = []
        ...
        for i in range(self.selected_player_count):
            ...
            if player:
                final_name = player["name"]  # kanonischer Name aus DB
            ...
            if rect.collidepoint(pos):
                ...
                # --- KALIBRIERUNG DIREKT AUFRUFEN ---
                    ...
                    if char == "BACK":
                        ...
                        if current_name:
                            # vorhandenen Namen übernehmen oder neuen anlegen
